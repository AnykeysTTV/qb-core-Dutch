...
- poly-Core Framework & SQL Keybinding Support ⚙️
...
If you’re using poly-core, you can now set
...
* poly-Core server owners, set `Framework = 'poly-core'` in the config file, otherwise leave it as false.
