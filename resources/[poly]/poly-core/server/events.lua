...
AddEventHandler('playerDropped', function(reason)
    ...
    TriggerEvent('poly-log:server:CreateLog', 'joinleave', 'Dropped', 'red', '**' .. GetPlayerName(src) .. '** (' .. Player.PlayerData.license .. ') left..' ..'\n **Reason:** ' .. reason)
...
RegisterNetEvent('QBCore:Server:UseItem', function(item)
    print(string.format("%s triggered QBCore:Server:UseItem by ID %s with the following data. This event is deprecated due to exploitation, and will be removed soon. Check poly-inventory for the right use on this event.", GetInvokingResource(), source))
    QBCore.Debug(item)
end)
...
-- Non-Chat Command Calling (ex: poly-adminmenu)
...
-- https://github.com/qbcore-framework/poly-inventory/blob/e4ef156d93dd1727234d388c3f25110c350b3bcf/server/main.lua#L2066
--end)
