...
RegisterNetEvent('QBCore:Client:VehicleInfo', function(info)
    ...
    if GetResourceState('poly-vehiclekeys') == 'started' then
        hasKeys = exports['poly-vehiclekeys']:HasKeys()
    end
...
RegisterNetEvent('QBCore:Client:UseItem', function(item)
    QBCore.Debug(string.format("%s triggered QBCore:Client:UseItem by ID %s with the following data. This event is deprecated due to exploitation, and will be removed soon. Check poly-inventory for the right use on this event.", GetInvokingResource(), GetPlayerServerId(PlayerId())))
    QBCore.Debug(item)
end)
