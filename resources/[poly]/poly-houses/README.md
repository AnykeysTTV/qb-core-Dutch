# poly-houses
Real Estate for poly-Core Framework :house_with_garden:
...
- [poly-radialmenu](https://github.com/qbcore-framework/poly-radialmenu) - For the menu in screenshots
- [poly-anticheat](https://github.com/qbcore-framework/poly-anticheat) - Anti Cheat 
- [poly-phone](https://github.com/qbcore-framework/poly-phone) - Houses app
- [poly-multicharacter](https://github.com/qbcore-framework/poly-multicharacter) - Checking if player is inside after character chosen (You need to edit the lines if you don't use this)
- [poly-garages](https://github.com/qbcore-framework/poly-garages) - House Garage
- [poly-interior](https://github.com/qbcore-framework/poly-interior) - Necessary for house interiors
- [poly-clothing](https://github.com/qbcore-framework/poly-clothing) - Outfits
- [poly-weathersync](https://github.com/qbcore-framework/poly-weathersync) - Desync weather inside house
- [poly-weed](https://github.com/qbcore-framework/poly-weed) - Weed plant
- [poly-skillbar](https://github.com/qbcore-framework/poly-skillbar) - Skills
...
- Import `poly-houses.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure poly-core
ensure poly-radialmenu
ensure poly-anticheat
ensure poly-phone
ensure poly-multicharacter
ensure poly-garages
ensure poly-interior
ensure poly-clothing
ensure poly-weathersync
ensure poly-weed
ensure poly-skillbar
```
