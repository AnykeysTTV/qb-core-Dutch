...
RegisterNetEvent('poly-gangmenu:client:Stash', function()
...
RegisterNetEvent('poly-gangmenu:client:Warbobe', function()
...
RegisterNetEvent('poly-gangmenu:client:OpenMenu', function()
    shownGangMenu = true
    local gangMenu = {
        {
        ...
        },
        {
            ...
            params = {
                event = "poly-gangmenu:client:ManageGang",
            }
        },
        {
            ...
            params = {
                event = "poly-gangmenu:client:HireMembers",
            }
        },
        {
            ...
            params = {
                event = "poly-gangmenu:client:Stash",
            }
        },
        {
            ...
            params = {
                event = "poly-gangmenu:client:Warbobe",
            }
        },
        {
            ...
            params = {
                event = "poly-gangmenu:client:SocietyMenu",
            }
        },
    }
    ...
    gangMenu[#gangMenu + 1] = {
        ...
        params = {
            event = "poly-menu:closeMenu",
        }
    }

    exports['poly-menu']:openMenu(gangMenu)
end)

RegisterNetEvent('poly-gangmenu:client:ManageGang', function()
    ...
    QBCore.Functions.TriggerCallback('poly-gangmenu:server:GetEmployees', function(cb)
        for _, v in pairs(cb) do
            GangMembersMenu[#GangMembersMenu + 1] = {
                ...
                params = {
                    event = "poly-gangmenu:lient:ManageMember",
                    args = {
                        player = v,
                        work = PlayerGang
                    }
        ...
        GangMembersMenu[#GangMembersMenu + 1] = {
            ...
            icon = "fa-solid fa-angle-left",
            params = {
                event = "poly-gangmenu:client:OpenMenu",
            }
        }
        exports['poly-menu']:openMenu(GangMembersMenu)
    end, PlayerGang.name)
end)

RegisterNetEvent('poly-gangmenu:lient:ManageMember', function(data)
    local MemberMenu = {
        {
    ...
    for k, v in pairs(QBCore.Shared.Gangs[data.work.name].grades) do
        MemberMenu[#MemberMenu + 1] = {
            ...
            params = {
                isServer = true,
                event = "poly-gangmenu:server:GradeUpdate",
    ...
    MemberMenu[#MemberMenu + 1] = {
        ...
        params = {
            isServer = true,
            event = "poly-gangmenu:server:FireMember",
    ...
    exports['poly-menu']:openMenu(MemberMenu)
end)

RegisterNetEvent('poly-gangmenu:client:HireMembers', function()
    ...
    QBCore.Functions.TriggerCallback('poly-gangmenu:getplayers', function(players)
        for _, v in pairs(players) do
            if v and v ~= PlayerId() then
                HireMembersMenu[#HireMembersMenu + 1] = {
                    ...
                    params = {
                        isServer = true,
                        event = "poly-gangmenu:server:HireMember",
                        args = v.sourceplayer
                    }
                }
            end
        ...
        exports['poly-menu']:openMenu(HireMembersMenu)
    end)
end)

RegisterNetEvent('poly-gangmenu:client:SocietyMenu', function()
    QBCore.Functions.TriggerCallback('poly-gangmenu:server:GetAccount', function(cb)
        local SocietyMenu = {
            {
            ...
            },
            {
                ...
                params = {
                    event = "poly-gangmenu:client:SocietyDeposit",
            ...
            },
            {
                ...
                params = {
                    event = "poly-gangmenu:client:SocietyWithdraw",
                    args = comma_valueGang(cb)
                }
            },
            {
        ...
        exports['poly-menu']:openMenu(SocietyMenu)
    end, PlayerGang.name)
end)

RegisterNetEvent('poly-gangmenu:client:SocietyDeposit', function(saldoattuale)
    local deposit = exports['poly-input']:ShowInput({
    ...
    if deposit then
        ...
        TriggerServerEvent("poly-gangmenu:server:depositMoney", tonumber(deposit.amount))
    end
end)

RegisterNetEvent('poly-gangmenu:client:SocietyWithdraw', function(saldoattuale)
    local withdraw = exports['poly-input']:ShowInput({
    ...
    if withdraw then
        ...
        TriggerServerEvent("poly-gangmenu:server:withdrawMoney", tonumber(withdraw.amount))
    end
end)
    ...
    if Config.UseTarget then
        for gang, zones in pairs(Config.GangMenuZones) do
            for index, data in ipairs(zones) do
                exports['poly-target']:AddBoxZone(gang.."-GangMenu"..index, data.coords, data.length, data.width, {
                            ...
                            if #(pos - coords) < 5.0 then
                                ...
                                if #(pos - coords) <= 1.5 then
                                    ...
                                    if not shownGangMenu then
                                        exports['poly-core']:DrawText(Lang:t("drawtextgang.label"), 'left')
                                    end

                                    if IsControlJustReleased(0, 38) then
                                        exports['poly-core']:HideText()
                                        TriggerEvent("poly-gangmenu:client:OpenMenu")
                                    end
                                end
