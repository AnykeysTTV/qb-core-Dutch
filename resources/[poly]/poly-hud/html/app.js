...
function closeMenu() {
  ...
  $.post('https://poly-hud/closeMenu');
}
function restartHud() {
  closeMenu()
  $.post('https://poly-hud/restartHud');
}
function resetStorage() {
  closeMenu()
  $.post('https://poly-hud/resetStorage');
}
function showOutMap() {
  $.post('https://poly-hud/showOutMap');
}
function showOutCompass() {
  $.post('https://poly-hud/showOutCompass');
}
function showFollowCompass() {
  $.post('https://poly-hud/showFollowCompass');
}
function openMenuSounds() {
  $.post('https://poly-hud/openMenuSounds');
}
function resetHudSounds() {
  $.post('https://poly-hud/resetHudSounds');
}
function checklistSounds() {
  $.post('https://poly-hud/checklistSounds');
}
function showMapNotif() {
  $.post('https://poly-hud/showMapNotif');
}
function showFuelAlert() {
  $.post('https://poly-hud/showFuelAlert');
}
function showCinematicNotif() {
  $.post('https://poly-hud/showCinematicNotif');
}
function dynamicHealth() {
  $.post('https://poly-hud/dynamicHealth');
}
function dynamicArmor() {
  $.post('https://poly-hud/dynamicArmor');
}
function dynamicHunger() {
  $.post('https://poly-hud/dynamicHunger');
}
function dynamicThirst() {
  $.post('https://poly-hud/dynamicThirst');
}
function dynamicStress() {
  $.post('https://poly-hud/dynamicStress');
}
function dynamicOxygen() {
  $.post('https://poly-hud/dynamicOxygen');
}
function dynamicEngine() {
  $.post('https://poly-hud/dynamicEngine');
}
function dynamicNitro() {
  $.post('https://poly-hud/dynamicNitro');
}
function ToggleMapShape() {
  $.post('https://poly-hud/ToggleMapShape');
}
function changeFPS() {
  $.post('https://poly-hud/changeFPS');
}
function ToggleMapBorders() {
  $.post('https://poly-hud/ToggleMapBorders');
}
function HideMap() {
  $.post('https://poly-hud/HideMap');
}
function changeCompassFPS() {
  $.post('https://poly-hud/changeCompassFPS');
}
function showCompassBase() {
  $.post('https://poly-hud/showCompassBase');
}
function showStreetsNames() {
  $.post('https://poly-hud/showStreetsNames');
}
function showPointerIndex() {
  $.post('https://poly-hud/showPointerIndex');
}
function showDegreesNum() {
  $.post('https://poly-hud/showDegreesNum');
}
function cinematicMode() {
  $.post('https://poly-hud/cinematicMode');
}
