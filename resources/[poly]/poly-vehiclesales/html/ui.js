var app = new Vue({
    ...
    methods: {
        sell(sellPrice) {
            ...
            if (this.sellPrice != "") {
                if (!isNaN(sellPrice)) {
                    ...
                    fetch("https://poly-vehiclesales/sellVehicle", requestOptions);
                    this.close();
                } else {
        ...
        buy() {
            ...
            fetch("https://poly-vehiclesales/buyVehicle", requestOptions);
            this.close();
        },
        takeBack() {
            const requestOptions = {
            ...
            fetch("https://poly-vehiclesales/takeVehicleBack", requestOptions);
            this.close();
        },
        close() {
            const requestOptions = {
            ...
            fetch("https://poly-vehiclesales/close", requestOptions);
