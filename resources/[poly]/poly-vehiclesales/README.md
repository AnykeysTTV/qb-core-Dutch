# poly-vehiclesales
Used Car Sale for poly-Core Framework :blue_car:
...
- [poly-garages](https://github.com/qbcore-framework/poly-garages) - Vehicle ownership
- [poly-phone](https://github.com/qbcore-framework/poly-phone) - For the e-mail
- [poly-logs](https://github.com/qbcore-framework/poly-logs) - Keep event logs
...
- Import `poly-vehiclesales.sql` in your database
...
ensure poly-vehiclesales
```

## Configuration
- To adjust tax, go to poly-vehiclesales\server\main.lua row 85 and change "77" to your liking
```
Config = Config or {}
