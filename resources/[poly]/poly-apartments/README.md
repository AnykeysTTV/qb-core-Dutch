# poly-apartments
Apartments System for poly-Core Framework :office:
...
- [poly-clothing](https://github.com/qbcore-framework/poly-clothing) - To save outfits
- [poly-houses](https://github.com/qbcore-framework/poly-houses) - House logic
- [poly-interior](https://github.com/qbcore-framework/poly-interior) - Interior logic
- [poly-weathersync](https://github.com/qbcore-framework/poly-weathersync) - To desync weather while inside
- [poly-spawn](https://github.com/qbcore-framework/poly-spawn) - To spawn the player at apartment if last location was in apartment
...
- Import `poly-apartments.sql` in your database
