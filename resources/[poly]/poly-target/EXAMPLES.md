...
```lua
exports['poly-target']:AddBoxZone("MissionRowDutyClipboard", vector3(441.7989, -982.0529, 30.67834), 0.45, 0.35, {
...
exports['poly-target']:AddTargetModel(Config.Peds, {
	options = {
		{
...
exports['poly-target']:AddTargetEntity(mule, {
    options = {
        {
            type = "client",
...
## Passing Item Data
In this example, we define the model of the coffee machines you see around the map, and allow players to purchase a coffee. You'll have to provide your own logic for the purchase, but this is how you would handle it with poly-target, and how you would pass data through to an event for future use.
...
```lua
exports['poly-target']:AddTargetModel(`prop_vend_coffe_01`, {
    options = {
        {
            type = "client",
            event = "coffee:buy",
...
AddEventHandler('plantpotato',function()
	...
	exports['poly-target']:AddEntityZone("potato-growing-"..plant, plant, {
