...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    ...
    TriggerServerEvent('poly-vehicleshop:server:addPlayer', citizenid)
    TriggerServerEvent('poly-vehicleshop:server:checkFinance')
...
RegisterNetEvent('QBCore:Client:OnPlayerUnload', function()
    local citizenid = PlayerData.citizenid
    TriggerServerEvent('poly-vehicleshop:server:removePlayer', citizenid)
    PlayerData = {}
end)
...
local vehHeaderMenu = {
    {
        ...
        params = {
            event = 'poly-vehicleshop:client:showVehOptions'
        }
    }
}
...
local financeMenu = {
    {
        ...
        params = {
            event = 'poly-vehicleshop:client:getVehicles'
        }
    }
}
...
local returnTestDrive = {
    {
        ...
        params = {
            event = 'poly-vehicleshop:client:TestDriveReturn'
        }
    }
}
...
local function createTestDriveReturn()
    ...
    testDriveZone:onPlayerInOut(function(isPointInside)
        if isPointInside and IsPedInAnyVehicle(PlayerPedId()) then
            ...
            exports['poly-menu']:openMenu(returnTestDrive)
        else
        ...
        while inTestDrive do
            if GetGameTimer() < gameTimer + tonumber(1000 * testDriveTime) then
                ...
                if secondsLeft >= tonumber(1000 * testDriveTime) - 20 or GetPedInVehicleSeat(NetToVeh(testDriveVeh), -1) ~= PlayerPedId() then
                    TriggerServerEvent('poly-vehicleshop:server:deleteVehicle', testDriveVeh)
                    testDriveVeh = 0
                    inTestDrive = false
...
local function createVehZones(shopName, entity)
    if not Config.UsingTarget then
        ...
        combo:onPlayerInOut(function(isPointInside)
            if isPointInside then
                if PlayerData and PlayerData.job and (PlayerData.job.name == Config.Shops[insideShop]['Job'] or Config.Shops[insideShop]['Job'] == 'none') then
                    exports['poly-menu']:showHeader(vehHeaderMenu)
                end
            else
                exports['poly-menu']:closeMenu()
            end
        ...
        exports['poly-target']:AddTargetEntity(entity, {
            options = {
                {
                    type = "client",
                    event = "poly-vehicleshop:client:showVehOptions",
                ...
                while insideShop do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'poly-vehicleshop:client:TestDrive',
                            }
                        },
                        {
                            ...
                            params = {
                                isServer = true,
                                event = 'poly-vehicleshop:server:buyShowroomVehicle',
                                args = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'poly-vehicleshop:client:openFinance',
                                args = {
                                    price = getVehPrice(),
                                    buyVehicle = Config.Shops[insideShop]["ShowroomVehicles"][ClosestVehicle].chosenVehicle
                                }
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'poly-vehicleshop:client:vehCategories',
                            }
                        },
                    }
                    Wait(1000)
                ...
                while insideShop and PlayerData.job and PlayerData.job.name == Config.Shops[name]['Job'] do
                    ...
                    vehicleMenu = {
                        ...
                        },
                        {
                            ...
                            params = {
                                event = 'poly-vehicleshop:client:openIdMenu',
                                args = {
                        ...
                        },
                        {
                            ...
                            icon = "fa-solid fa-coins",
                            params = {
                                event = 'poly-vehicleshop:client:openCustomFinance',
                                args = {
                                    price = getVehPrice(),
                                    vehicle = Config.Shops[insideShop]["ShowroomVehicles"][ClosestVehicle].chosenVehicle
                                }
...
function Init()
    ...
    CreateThread(function()
        ...
        financeZone:onPlayerInOut(function(isPointInside)
            if isPointInside then
                exports['poly-menu']:showHeader(financeMenu)
            else
                exports['poly-menu']:closeMenu()
            end
        end)
...
-- Events
RegisterNetEvent('poly-vehicleshop:client:homeMenu', function()
    exports['poly-menu']:openMenu(vehicleMenu)
end)

RegisterNetEvent('poly-vehicleshop:client:showVehOptions', function()
    exports['poly-menu']:openMenu(vehicleMenu, true, true)
end)

RegisterNetEvent('poly-vehicleshop:client:TestDrive', function()
...
RegisterNetEvent('poly-vehicleshop:client:customTestDrive', function(data)
...
RegisterNetEvent('poly-vehicleshop:client:TestDriveReturn', function()
...
RegisterNetEvent('poly-vehicleshop:client:vehCategories', function()
	local catmenu = {}
    local categoryMenu = {
        {
            ...
            params = {
                event = 'poly-vehicleshop:client:homeMenu'
            }
        }
    }
    ...
    for k, v in pairs(catmenu) do
        categoryMenu[#categoryMenu + 1] = {
            ...
            params = {
                event = 'poly-vehicleshop:client:openVehCats',
                args = {
                    catName = k
                }
            }
    ...
    exports['poly-menu']:openMenu(categoryMenu)
end)

RegisterNetEvent('poly-vehicleshop:client:openVehCats', function(data)
    local vehMenu = {
        {
            header = Lang:t('menus.goback_header'),
            icon = "fa-solid fa-angle-left",
                ...
                for _, shop in pairs(QBCore.Shared.Vehicles[k]["shop"]) do
                    if shop == insideShop then
                        vehMenu[#vehMenu + 1] = {
                            ...
                            params = {
                                isServer = true,
                                event = 'poly-vehicleshop:server:swapVehicle',
                                args = {
                                    toVehicle = v.model,
    ...
    exports['poly-menu']:openMenu(vehMenu)
end)

RegisterNetEvent('poly-vehicleshop:client:openFinance', function(data)
    local dialog = exports['poly-input']:ShowInput({
    ...
    if dialog then
        ...
        TriggerServerEvent('poly-vehicleshop:server:financeVehicle', dialog.downPayment, dialog.paymentAmount, data.buyVehicle)
    end
end)

RegisterNetEvent('poly-vehicleshop:client:openCustomFinance', function(data)
    ...
    if dialog then
        ...
        TriggerServerEvent('poly-vehicleshop:server:sellfinanceVehicle', dialog.downPayment, dialog.paymentAmount, data.vehicle, dialog.playerid)
    end
end)

RegisterNetEvent('poly-vehicleshop:client:swapVehicle', function(data)
...
RegisterNetEvent('poly-vehicleshop:client:buyShowroomVehicle', function(vehicle, plate)
    tempShop = insideShop -- temp hacky way of setting the shop because it changes after the callback has returned since you are outside the zone
    QBCore.Functions.TriggerCallback('QBCore:Server:SpawnVehicle', function(netId)
        local veh = NetToVeh(netId)
        exports['LegacyFuel']:SetFuel(veh, 100)
        ...
        TriggerEvent("vehiclekeys:client:SetOwner", QBCore.Functions.GetPlate(veh))
        TriggerServerEvent("poly-vehicletuning:server:SaveVehicleProps", QBCore.Functions.GetVehicleProperties(veh))
    end, vehicle, Config.Shops[tempShop]["VehicleSpawn"], true)
end)

RegisterNetEvent('poly-vehicleshop:client:getVehicles', function()
    QBCore.Functions.TriggerCallback('poly-vehicleshop:server:getVehicles', function(vehicles)
        local ownedVehicles = {}
        for _, v in pairs(vehicles) do
            if v.balance ~= 0 then
                ...
                ownedVehicles[#ownedVehicles + 1] = {
                    ...
                    icon = "fa-solid fa-car-side",
                    params = {
                        event = 'poly-vehicleshop:client:getVehicleFinance',
                        args = {
                            vehiclePlate = plate,
                            balance = v.balance,
        ...
        if #ownedVehicles > 0 then
            exports['poly-menu']:openMenu(ownedVehicles)
        else
...
RegisterNetEvent('poly-vehicleshop:client:getVehicleFinance', function(data)
    local vehFinance = {
        {
            header = Lang:t('menus.goback_header'),
            params = {
        ...
        },
        {
            ...
            icon = "fa-solid fa-hand-holding-dollar",
            params = {
                event = 'poly-vehicleshop:client:financePayment',
                args = {
                    vehData = data,
        ...
        },
        {
            ...
            params = {
                isServer = true,
                event = 'poly-vehicleshop:server:financePaymentFull',
                args = {
    ...
    exports['poly-menu']:openMenu(vehFinance)
end)

RegisterNetEvent('poly-vehicleshop:client:financePayment', function(data)
    local dialog = exports['poly-input']:ShowInput({
    ...
    if dialog then
        ...
        TriggerServerEvent('poly-vehicleshop:server:financePayment', dialog.paymentAmount, data.vehData)
    end
end)

RegisterNetEvent('poly-vehicleshop:client:openIdMenu', function(data)
    local dialog = exports['poly-input']:ShowInput({
    ...
    if dialog then
        ...
        if data.type == 'testDrive' then
            TriggerServerEvent('poly-vehicleshop:server:customTestDrive', data.vehicle, dialog.playerid)
        elseif data.type == 'sellVehicle' then
            TriggerServerEvent('poly-vehicleshop:server:sellShowroomVehicle', data.vehicle, dialog.playerid)
        end
    end
end)
