# poly-policejob
Police Job for poly-Core Framework :police_officer:
...
- [poly-bossmenu](https://github.com/qbcore-framework/poly-bossmenu)  (Deprecated) - For the boss menu
- [poly-management](https://github.com/qbcore-framework/poly-management) (Replaces poly-bossmenu) - For the boss/gang menu
- [poly-garages](https://github.com/qbcore-framework/poly-garages) - For the vehicle spawner
- [poly-clothing](https://github.com/qbcore-framework/poly-clothing) - For the locker room
- [poly-phone](https://github.com/qbcore-framework/poly-phone) - For the MEOS app and notifications etc.
- [poly-log](https://github.com/qbcore-framework/poly-logs) - (Deprecated) - For logging certain events
- [poly-smallresources](https://github.com/qbcore-framework/poly-smallresources) (Replaces poly-log) - poly-log was added to poly-smallresources
- [poly-menu](https://github.com/qbcore-framework/poly-menu) - For the vehicle menus
- [poly-input](https://github.com/qbcore-framework/poly-input) - For accessing evidence stashes
