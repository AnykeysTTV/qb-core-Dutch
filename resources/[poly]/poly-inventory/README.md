...
- [poly-logs](https://github.com/qbcore-framework/poly-logs) - For logging transfer and other history
- [poly-traphouse](https://github.com/qbcore-framework/poly-traphouse) - Trap house system for qbcore
- [poly-radio](https://github.com/qbcore-framework/poly-radio) - Radio system for communication
- [poly-drugs](https://github.com/qbcore-framework/poly-drugs) -  Drugs and Weed Planting System
- [poly-shops](https://github.com/qbcore-framework/poly-shops) - Needed in order to add shops
...
- Import `poly-inventory.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure poly-core
ensure poly-logs
ensure poly-inventory
ensure poly-traphouse
ensure poly-radio
ensure poly-drugs
ensure poly-shops
```
...
Config.UseTarget = GetConvar('UseTarget', 'false') == 'true' -- Use poly-target interactions (don't change this, go to your server.cfg and add `setr UseTarget true` to use this and just that from true to false or the other way around)
