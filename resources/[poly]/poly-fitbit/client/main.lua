...
RegisterNetEvent('poly-fitbit:use', function()
    openWatch()
end)
...
RegisterNUICallback('setFoodWarning', function(data, cb)
    ...
    TriggerServerEvent('poly-fitbit:server:setValue', 'food', foodValue)
...
RegisterNUICallback('setThirstWarning', function(data, cb)
    ...
    TriggerServerEvent('poly-fitbit:server:setValue', 'thirst', thirstValue)
