local Translations = {
    ...
    success = {
        ...
        ["changed_perm"] = "Autoriteitgroep ~g~E~w~ijzigd",
    ...
    info = {
        ...
        ["staffchat"] = "STAFFCHAT - ",
        ["warning_chat_message"] = "^8WAARSCHUWING ^7 Je bent ~g~E~w~aarschuwd door",
        ["warning_staff_message"] = "^WAARSCHUWING ^7 Je hebt ~g~E~w~aarschuwd ",
    ...
    menu = {
        ...
        ["hud_dev_mode"] = "Dev Modus (poly-hud)",
    ...
    weather = {
        ...
        ["neutral"] = "Neutraal",
        ["neutral_desc"] = "Een ~g~E~w~one dag!",
        ["smog"] = "Rook",
