...
CreateThread(function()
    while true do
        ...
        if NetCheck1 or NetCheck2 then
            TriggerServerEvent('poly-admin:server:GetPlayersForBlips')
        end
    end
end)

RegisterNetEvent('poly-admin:client:toggleBlips', function()
...
RegisterNetEvent('poly-admin:client:toggleNames', function()
...
RegisterNetEvent('poly-admin:client:Show', function(players)
