...
QBCore.Functions.CreateUseableItem("tunerlaptop", function(source)
    TriggerClientEvent('poly-tunerchip:client:openChip', source)
end)

RegisterNetEvent('poly-tunerchip:server:TuneStatus', function(plate, bool)
    if bool then
...
QBCore.Functions.CreateCallback('poly-tunerchip:server:HasChip', function(source, cb, data)
    local src = source
...
QBCore.Functions.CreateCallback('poly-tunerchip:server:GetStatus', function(_, cb, plate)
