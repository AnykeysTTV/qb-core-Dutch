...
$(document).on('click', '#save', function(){
    $.post('https://poly-tunerchip/save', JSON.stringify({
...
$(document).on('click', '#reset', function(){
    $.post('https://poly-tunerchip/reset');
});
...
$(document).on('click', "#save-neon", function(){
    if (RainbowNeon) {
        $.post('https://poly-tunerchip/saveNeon', JSON.stringify({
...
$(document).on('click', '#save-headlights', function(){
    $.post('https://poly-tunerchip/saveHeadlights', JSON.stringify({
        value: headlightVal,
...
$(document).on('click', '#save-stancer', function(){
    ...
    $.post('https://poly-tunerchip/SetStancer', JSON.stringify({
...
QBTuner.Open = function() {
    $.post('https://poly-tunerchip/checkItem', JSON.stringify({item: "tunerlaptop"}), function(hasItem){
        if (hasItem) {
...
QBTuner.Close = function() {
    ...
    $.post('https://poly-tunerchip/exit');
}