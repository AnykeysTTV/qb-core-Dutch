...
RegisterNetEvent('poly-bankrobbery:client:SetStationStatus', function(key, isHit)
    ...
    QBCore.Functions.TriggerCallback("thermite:server:check", function(success)
        if success then
            ...
            if currentStation ~= 0 then
                ...
                TriggerServerEvent("poly-bankrobbery:server:SetStationStatus", currentStation, true)
