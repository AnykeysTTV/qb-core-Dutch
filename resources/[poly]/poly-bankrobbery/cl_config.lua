...
-- This is the handler for the cop count, you can change this to anything you want as this is by default the poly-policejob event
...
function Config.DoorlockAction(doorId, setLocked)
    TriggerServerEvent('poly-doorlock:server:updateState', doorId, setLocked, false, false, true, false, false)
end
...
function Config.OnHackDone(success, bank)
    ...
    TriggerServerEvent('poly-bankrobbery:server:setBankState', bank)
end
