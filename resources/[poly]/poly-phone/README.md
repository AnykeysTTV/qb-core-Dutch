# poly-phone
Advanced Phone for poly-Core Framework :iphone:
...
- [poly-policejob](https://github.com/qbcore-framework/poly-policejob) - MEOS, handcuff check etc. 
- [poly-crypto](https://github.com/qbcore-framework/poly-crypto) - Crypto currency trading 
- [poly-lapraces](https://github.com/qbcore-framework/poly-lapraces) - Creating routes and racing 
- [poly-houses](https://github.com/qbcore-framework/poly-houses) - House and Key Management App
- [poly-garages](https://github.com/qbcore-framework/poly-garages) - For Garage App
- [poly-banking](https://github.com/qbcore-framework/poly-banking) - For Banking App
...
- Import `poly-phone.sql` in your database
