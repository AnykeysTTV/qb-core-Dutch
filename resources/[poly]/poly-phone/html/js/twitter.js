...
$(document).on('click', '.twitter-header-tab', function(e){
    ...
    if (PressedTwitterTab !== CurrentTwitterTab) {
        ...
        if (PressedTwitterTab === "twitter-mentions") {
            $.post('https://poly-phone/ClearMentions');
        }
...
$(document).on('click','#twt-delete-click',function(e){
    ...
    $.post('https://poly-phone/DeleteTweet', JSON.stringify({id: source}))
})
...
$(document).on('click', '#send-tweet', function(e){
    ...
    if (TweetMessage != "") {
        ...
        $.post('https://poly-phone/PostNewTweet', JSON.stringify({
...
$(document).on('click', '.hashtag-tag-text', function(e){
    ...
    if (!HashtagOpen) {
        ...
        $.post('https://poly-phone/GetHashtagMessages', JSON.stringify({hashtag: Hashtag}), function(HashtagData){
