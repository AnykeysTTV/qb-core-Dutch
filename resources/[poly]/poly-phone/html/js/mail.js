...
$(document).on('click', '#accept-mail', function(e){
    ...
    $.post('https://poly-phone/AcceptMailButton', JSON.stringify({
...
$(document).on('click', '#remove-mail', function(e){
    e.preventDefault();
    var MailData = $("#"+OpenedMail).data('MailData');
    $.post('https://poly-phone/RemoveMail', JSON.stringify({
        mailId: MailData.mailid
    }));
    $(".mail-home").animate({
        left: 0+"vh"
...
$(document).on('click','#new-advert-photo',function(e){
    e.preventDefault();
    $.post('https://poly-phone/TakePhoto',function(url){
        if(url){
...
$(document).on('click','#adv-delete',function(e){
    e.preventDefault();
    $.post('https://poly-phone/DeleteAdvert', function(){
        setTimeout(function(){
