...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('poly-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('poly-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('poly-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('poly-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('poly-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('poly-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
