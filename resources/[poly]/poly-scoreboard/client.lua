...
RegisterNetEvent('poly-scoreboard:client:SetActivityBusy', function(activity, busy)
...
if Config.Toggle then
    RegisterCommand('scoreboard', function()
        if not scoreboardOpen then
            QBCore.Functions.TriggerCallback('poly-scoreboard:server:GetScoreboardData', function(players, cops, playerList)
