...
RegisterServerEvent('poly-armoredtruckheist:server:callCops', function(streetLabel, coords)
    -- local place = "Armored Truck"
    -- local msg = "The Alarm has been activated from a "..place.. " at " ..streetLabel
	-- Why is this unused?
    TriggerClientEvent("poly-armoredtruckheist:client:robberyCall", -1, streetLabel, coords)
end)
