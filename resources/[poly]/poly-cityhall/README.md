# poly-cityhall
City Services for poly-Core Framework

## Dependencies
- [poly-core](https://github.com/qbcore-framework/poly-core)
- [PolyZone](https://github.com/mkafrin/PolyZone) - For Interaction (DrawText and poly-target both require this)
- [poly-target](https://github.com/BerkieBb/poly-target) - For Interaction (Optional)
- [poly-phone](https://github.com/qbcore-framework/poly-phone) - For E-Mail
...
- poly-target integration, this is optional
- PolyZone and poly-core DrawText integration, this is optional
...
ensure poly-target # Optional
ensure poly-phone
ensure poly-cityhall
```
...
![Cityhall poly-Target Interaction](https://i.imgur.com/K54cMLt.png)
...
![Driving School poly-Target Interaction](https://i.imgur.com/P7jWBsV.png)
