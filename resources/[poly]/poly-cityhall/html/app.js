...
Close = function() {
    ...
    $.post('https://poly-cityhall/close');
...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $.post('https://poly-cityhall/requestLicenses', JSON.stringify({}), function(licenses){
...
$(".request-identity-button").click(function(e){
    e.preventDefault();
    $.post('https://poly-cityhall/requestId', JSON.stringify({
...
$(document).on('click', '.apply-job-button', function(e){
    e.preventDefault();
    $.post('https://poly-cityhall/applyJob', JSON.stringify(selectedJobId))
    ResetPages();
});
