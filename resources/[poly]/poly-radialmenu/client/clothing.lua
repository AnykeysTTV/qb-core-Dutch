...
RegisterNetEvent('poly-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('poly-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('poly-radialmenu:ToggleProps', ToggleProps)
